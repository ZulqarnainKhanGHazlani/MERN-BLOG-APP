...
const UserProfile = () => {
  ...
  //Redirect to login page for any user who isn't loged in
  useEffect(() => {
    if (!token) {
      navigate('/login')
    }
  ...
  const updateUserDetails = async (e) => {
    ...
    postData.set('confirmNewPassword', confirmNewPassword)
      const response = await axios.patch(`${process.env.REACT_APP_BASE_URL}/users/edit-user`, postData, { withCredentials: true, headers: { Authorization: `Bearer ${token}` } });
    ...
    <section className='profile'>
      <div className='container profile__container'>
        ...
        <div className='profile__details'>
          ...
          {/* form to update users's details */}
